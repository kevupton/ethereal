...
namespace Kevupton\BeastCore\Relations;
...
class HasManyThroughCustom extends Relation
{
    /**
     ...
     * @param $pivotKey
     */
    public function __construct(Builder $query, Model $farParent, Model $parent, $firstKey, $secondKey, $localKey, $pivotKey)
    {
    ...
    protected function setJoin(Builder $query = null)
    {
        ...
        $pivotKey = $this->pivotKey?: $this->getQualifiedParentKeyName();
        $query->join($this->parent->getTable(), $pivotKey, '=', $foreignKey);
